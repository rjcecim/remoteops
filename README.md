...
<h1 align="center">RemoteOps 1.8.0 (Build 79)</h1>
...
<p align="center">
  <img src="https://img.shields.io/badge/RemoteOps-1.8.0%20(Build%2079)-0F2744?style=for-the-badge" alt="RemoteOps 1.8.0 (Build 79)" />
</p>
...
Identidade do produto: **`RemoteOps 1.8.0 (Build 79)`** — a mesma string da janela, definida em `remoteops.core.version` (`__version__` + `__build__`) e exposta em `remoteops.ui.branding.APP_DISPLAY_NAME`.
...
<p align="center">
  <sub>RemoteOps 1.8.0 (Build 79) · Windows 10 / 11 · PyQt6 Fluent</sub>
</p>
