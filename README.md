...
<h1 align="center">RemoteOps 1.9.0 (Build 82)</h1>
...
<p align="center">
  <img src="https://img.shields.io/badge/RemoteOps-1.9.0%20(Build%2082)-0F2744?style=for-the-badge" alt="RemoteOps 1.9.0 (Build 82)" />
</p>
...
Identidade do produto: **`RemoteOps 1.9.0 (Build 82)`** — a mesma string da janela, definida em `remoteops.core.version` (`__version__` + `__build__`) e exposta em `remoteops.ui.branding.APP_DISPLAY_NAME`.
...
- Pesquisa de hosts na faixa de IP (TCP 445/135/139, usuário ativo, atalho para o PsExec)
...
<p align="center">
  <sub>RemoteOps 1.9.0 (Build 82) · Windows 10 / 11 · PyQt6 Fluent</sub>
</p>
